...
#define SPECIES_MEGA_TYPHLOSION (SPECIES_PLZA_MEGAS_START + 49)
#define SPECIES_MEGA_NIDOKING (SPECIES_PLZA_MEGAS_START + 50)
#define SPECIES_MEGA_DRAGAPULT (SPECIES_PLZA_MEGAS_START +51)
#define SPECIES_MEGA_NIDOQUEEN (SPECIES_PLZA_MEGAS_START + 52)
#define SPECIES_MEGA_GRIMMSNARL (SPECIES_PLZA_MEGAS_START + 53)
#define SPECIES_MEGA_MACHAMP (SPECIES_PLZA_MEGAS_START +54)
#define SPECIES_MEGA_BUTTERFREE (SPECIES_PLZA_MEGAS_START +55)
#define SPECIES_MEGA_CENTISKORCH (SPECIES_PLZA_MEGAS_START +56)

#define MAX_SPECIES_PLZA_MEGAS_FORM_NUM (SPECIES_MEGA_CENTISKORCH)
